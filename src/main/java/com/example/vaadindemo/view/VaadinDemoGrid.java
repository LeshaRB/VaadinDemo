...
import com.example.vaadindemo.dto.Person;
...
@Route(value = "grid", layout = VaadinDemoMainLayout.class)
public class VaadinDemoGrid extends VerticalLayout {

    List<Person> people = new ArrayList<>();

    public VaadinDemoGrid() {
